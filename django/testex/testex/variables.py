import os
# Set of All Queries/Variables

#DP PACKAGE DIRS
# # Global Variables
dest = os.path.expanduser("/home/hduser/separate-data/server-sql-data/")
dest = os.path.expanduser(dest)
dest_json = os.path.expanduser("/home/hduser/separate-data/server-json-data/")
dest_log = os.path.expanduser("/home/hduser/separate-data/server-log-data/")
dest_mongo = os.path.expanduser("/home/hduser/separate-data/server-mongo-data/")
...
#COMMON
FS_RESET = "rm -rf /home/hduser/separate-data"
...
DP_HDFS_PORT = '''
	...
	'''
LOCAL_HDFS_PORT="hadoop fs -copyFromLocal /home/hduser/separate-data/local-log-data /loginput/"
